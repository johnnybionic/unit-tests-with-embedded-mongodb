...
public class BasicSpringEmbeddedMongoApplication {
    ...
    /**
     * Registers a custom converter for our domain class. Spring documentation
     * is out of date for this :( So basically, work it out for yourself ...
     * This seems as good a place as any to do this - if it's done as part of
     * configuration (i.e. AbstractMongoConfiguration), it requires a lot more
     * to be set, things which are already set by default. Instead, let's get
     * the one Spring creates and add to it.
     */
    @PostConstruct
    private void init() {
